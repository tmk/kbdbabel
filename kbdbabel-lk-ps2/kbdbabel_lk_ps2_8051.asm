...
;
; $KbdBabel: kbdbabel_lk_ps2_8051.asm,v 1.3 2006/11/26 08:22:12 akurz Exp $
;
...
;
; Build:
; $ asl kbdbabel_lk_at_8051.asm -o kbdbabel_lk_at_8051.p
; $ p2bin -l \$ff kbdbabel_lk_at_8051
; write kbdbabel_lk_at_8051.bin on an empty 27C256 or AT89C2051
;
...
timer0_init:
	...
	mov	th0, #interval_t0_50u_11059_2k
	mov	tl0, #interval_t0_50u_11059_2k
...
; Id
;----------------------------------------------------------
RCSId	DB	"$Id: kbdbabel_lk_ps2_8051.asm,v 1.1 2006/11/27 23:03:56 akurz Exp $"
